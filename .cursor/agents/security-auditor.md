...
- **Invoke via:** explicit user request for security review, or after `product-verifier` flags security concerns.
- **Do not invoke from another persona.** If `product-verifier` flags something that warrants a deeper security pass, the user initiates this agent. See `.cursor/agents/README.md`.
