...
export function normalizeProductionOrder(order: ProductionOrder): ProductionOrder {
  return {
    ...
    warehouseItemId: order.warehouseItemId?.trim() || undefined,
    ...
    impregnationOutputItemId: order.impregnationOutputItemId?.trim() || undefined,
    ...
    semiFinishedItemId: order.semiFinishedItemId?.trim() || undefined,
    wipContractVersion: order.wipContractVersion === 1 ? 1 : undefined,
...
export function emptyProductionOrder(
  ...
  return {
    ...
    planMode: 'even',
    recalcMode: 'auto',
    semiFinishedItemId: undefined,
    impregnationOutputItemId: undefined,
    dayPlans: [],
    history: [],
    createdAt: now,
    updatedAt: now,
