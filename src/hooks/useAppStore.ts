...
export function useAppStore() {
  ...
  return {
    ...
    transferProductionOrderMaterials: warehouse.transferProductionOrderMaterials,
    returnProductionOrderMaterials: warehouse.returnProductionOrderMaterials,
    upsertProductionLineLocationBinding: warehouse.upsertProductionLineLocationBinding,
    ...
    confirmPackagingReport: production.confirmPackagingReport,
    confirmPackagingReportCorrection: production.confirmPackagingReportCorrection,
    listPendingQcLots: production.listPendingQcLots,
    listAvailableWipForPackaging: production.listAvailableWipForPackaging,
    startQcReview: production.startQcReview,
    upsertQcAttachment: production.upsertQcAttachment,
    releaseFinishedGoodsLot: production.releaseFinishedGoodsLot,
    mirrorServerQcRelease: production.mirrorServerQcRelease,
    requestRegrade: production.requestRegrade,
    rejectFinishedGoodsLot: production.rejectFinishedGoodsLot,
    applyRejectTransferToScrap: production.applyRejectTransferToScrap,
    captureLegacyRecipeNormOnOrder: production.captureLegacyRecipeNormOnOrder,
    ...
    setRoleAllowRecipeApproval: accessSlice.setRoleAllowRecipeApproval,
    setRoleAllowQcRelease: accessSlice.setRoleAllowQcRelease,
